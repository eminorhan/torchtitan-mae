...
# TODO: Should these go after the necessary classes are defined?
ffn_layer_dict = {
    "mlp": Mlp,
    "swiglu": SwiGLUFFN,
    ...
    def _forward_list(self, x_list: List[Tensor], rope_list=None) -> List[Tensor]:
        ...
        if self.training and self.sample_drop_ratio > 0.0:
            ...
            if rope_list is not None:
                rope_subset_list = [self._maybe_index_rope(rope, indices_1) for rope, indices_1 in zip(rope_list, indices_1_list)]
            else:
...
# ==================================================== #
# Define DinoVisionTransformer models of various sizes
