...
#SBATCH --time=6:00:00
#SBATCH --job-name=train_segmentation_3d_no_bf16
#SBATCH --output=train_segmentation_3d_no_bf16_%A_%a.out
#SBATCH --array=0
...
CONFIG_FILE=${CONFIG_FILE:-"./train_configs/dinov3_vitl16_3D_linear_scratch_no_bf16.toml"}
