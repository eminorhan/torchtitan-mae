...
# ---------------- CONFIGURATION ----------------
# Automatically grab all available logical cores on your HPC node (e.g., 72)
NUM_PROC = os.cpu_count() or 1 

# Keep a tiny 1GB cache per worker process to prevent I/O thrashing
WORKER_CACHE_SIZE = 1024**3 
# -----------------------------------------------
