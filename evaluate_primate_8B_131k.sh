...
#SBATCH --job-name=evaluate_primate_8B_131k
#SBATCH --output=evaluate_primate_8B_131k_%A_%a.out
#SBATCH --array=0
#SBATCH --qos=debug
...
CONFIG_FILE=${CONFIG_FILE:-"./eval_configs/primate_8b_131k.toml"}

srun torchrun --nnodes $SLURM_NNODES --nproc_per_node 8 --max_restarts 9 --node_rank $SLURM_NODEID --rdzv_id 101 --rdzv_backend c10d --rdzv_endpoint "$MASTER_ADDR:$MASTER_PORT" ./evaluate.py --job.config_file ${CONFIG_FILE}
